    ...
    function () {
        ...
        this.setTimeout(
            function () {
                ...
                this.window.alert(popMessage);//becase Window project is high prioirty
...
btn1.addEventListener("click",
    function () {
        ...
        // switch (n) { //Alt+Shift+downarrow key = Copy
        //     case 0:
        ...
        $(document).ready(function () {
            $(document).snowfall({
                ...
                minSize: 1, // 最小サイズ
                image: resultImage[n]//look the files from HTML file
            });
        });
