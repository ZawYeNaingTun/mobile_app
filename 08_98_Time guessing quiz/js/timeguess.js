...
const stop = document.getElementById("stop"); // Stop => stop
...
// Startボタンクリック
////////////////////////
start.addEventListener("click", // Stop => stop
  function() {
    // ボタンをタイマー"動作中"状態とする
    setButtonStateRunning();// r => R
    startTime = Date.now();
    countUp();
...
// Resetボタンクリック
////////////////////////
reset.addEventListener("click", // change => click
  function() {
    // ボタンを"初期"状態とする
    setButtonStateInitial()
